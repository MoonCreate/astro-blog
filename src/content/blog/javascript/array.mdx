---
title: "Array dan Method yang dimiliki Array"
description: "Materi tentang array"
pubDate: "Nov 8 2024"
...
import ArrayDemo from "#helper/array/ArrayDemo";

<Container>
    <ArrayDemo client:load />
</Container>
...
import PushDemo from "#helper/array/PushDemo";

<Container>
<PushDemo client:visible/>
</Container>
...
import SpliceDemo from "#helper/array/SpliceDemo";

<Container>
<SpliceDemo client:visible/>
</Container>
